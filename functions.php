...
if (! function_exists('themeslug_setup')) :
	/**
	...
	function themeslug_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__('Primary', 'themeslug'),
		) );
		...
		add_theme_support('custom-background', apply_filters('themeslug_custom_background_args', array(
 ...
 */
function themeslug_content_width() {
	$GLOBALS['content_width'] = apply_filters('themeslug_content_width', 640);
}
add_action('after_setup_theme', 'themeslug_content_width', 0);
...
function themeslug_scripts() {
  ...
  // Add Script bundle
	wp_enqueue_script('themeslug-script-bundle', get_template_directory_uri() . '/dist/script.bundle.js', array(), '20180218', true);
}
